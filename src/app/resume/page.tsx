    ...
    return (
        <main className="flex flex-col h-screen w-full justify-center items-center overflow-hidden"
            ...
            <div className="flex flex-col items-center justify-center w-[80%] h-[95%] pb-20">
                ...
                <p className="lg:text-base sm:text-xs font-light max-w-[50rem] text-white text-center">My resume showcases a culmination of my journey—highlighting my dedication to C++ and Desktop Applications. I invite you to explore my personal and professional accomplishments and discover how my expertise can contribute to your next project.</p>
                <iframe 
